...
class StateHandler extends EventHandler {
  ...
  onEnd() {
    ...
    this.minecraft.app.log.warn(`Minecraft bot desconectado do servidor, tentando reconectar em ${loginDelay / 1000} seconds`)

    setTimeout(() => this.minecraft.connect(), loginDelay)
  }

  onKicked(reason) {
    this.minecraft.app.log.warn(`Minecraft bot foi expulso do servidor por "${reason}"`)
